...
function runGame(gameType) {
    ...
    document.getElementById('answer-box').value = " "; //whenever the runGame is called, the answer box will be empty
    document.getElementById('answer-box').focus(); //each time the runGame is called, the answer box will have a cursor
